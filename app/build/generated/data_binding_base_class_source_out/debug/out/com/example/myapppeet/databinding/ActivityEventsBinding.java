...
public final class ActivityEventsBinding implements ViewBinding {
  ...
  private ActivityEventsBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull TextView noEventsMessage) {
  ...
  public static ActivityEventsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.noEventsMessage;
      TextView noEventsMessage = ViewBindings.findChildViewById(rootView, id);
      if (noEventsMessage == null) {
        break missingId;
      }

      return new ActivityEventsBinding((RelativeLayout) rootView, eventsRecyclerView, fabAddEvent,
          noEventsMessage);
    }
