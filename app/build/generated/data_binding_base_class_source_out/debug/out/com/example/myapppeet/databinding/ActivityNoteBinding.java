...
public final class ActivityNoteBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView noNotesMessage;

  @NonNull
  public final RecyclerView notesRecyclerView;

  private ActivityNoteBinding(@NonNull RelativeLayout rootView,
      @NonNull FloatingActionButton fabAddNote, @NonNull TextView noNotesMessage,
  ...
  public static ActivityNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.noNotesMessage;
      TextView noNotesMessage = ViewBindings.findChildViewById(rootView, id);
      if (noNotesMessage == null) {
        break missingId;
      }
      ...
      return new ActivityNoteBinding((RelativeLayout) rootView, fabAddNote, noNotesMessage,
          notesRecyclerView);
    }
